          ...
          <div className="group/card text-card-foreground rounded-xl transition-all duration-200 bg-card hover:border-slate-7 hover:text-slate-12 border shadow-sm hover:shadow-lg p-4 flex flex-col gap-4 group h-full">
            <div className="flex flex-col gap-2 h-full">
              ...
              <p className="text-sm text-muted-foreground">
                Discover AI models across our collection, from all major labs
                and providers.
              </p>
            </div>
        ...
        <a className="flex-1" href="/rankings">
          <div className="group/card text-card-foreground rounded-xl transition-all duration-200 bg-card hover:border-slate-7 hover:text-slate-12 border shadow-sm hover:shadow-lg p-4 flex flex-col gap-4 group h-full">
            <div className="flex flex-col gap-2 h-full">
              ...
              <p className="text-sm text-muted-foreground">
                Explore token usage across models, labs, and public
                applications.
              </p>
            </div>
            <span className="text-muted-foreground inline-flex items-center">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-6">
            ...
            <AnnouncementCard
              ...
              date="7/13/2025"
              link="/announcements/cursor-kimi"
            />
          </div>
        </div>
      </div>
...
const AnnouncementCard = ({ title, description, date, isNew = false, link }: {
  title: string;
  description: string;
  date: string;
  isNew?: boolean;
